...
function obtenerInsumos() {
    ...
    $consulta = "SELECT c.id_compra AS id_insumo, c.marca AS nombre_insumo, c.cantidad, p.nombre_proveedor, c.fecha_compra, c.total_compra AS precio, 'Buen Estado' AS estado_insumo
                 FROM compras c
